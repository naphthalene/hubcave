...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.when'
        db.add_column(u'game_message', 'when',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 11, 16, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.when'
        db.delete_column(u'game_message', 'when')
