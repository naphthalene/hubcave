...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StackableInventoryItem'
        db.create_table(u'game_stackableinventoryitem', (
            (u'inventoryitem_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['game.InventoryItem'], unique=True, primary_key=True)),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'game', ['StackableInventoryItem'])

        # Adding field 'Item.stackable'
        db.add_column(u'game_item', 'stackable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StackableInventoryItem'
        db.delete_table(u'game_stackableinventoryitem')

        # Deleting field 'Item.stackable'
        db.delete_column(u'game_item', 'stackable')
    ...
    models = {
        ...
        u'game.item': {
            ...
            'stackable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'game.stackableinventoryitem': {
            'Meta': {'object_name': 'StackableInventoryItem', '_ormbases': [u'game.InventoryItem']},
            'count': ('django.db.models.fields.IntegerField', [], {}),
            u'inventoryitem_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['game.InventoryItem']", 'unique': 'True', 'primary_key': 'True'})
        }
    }
