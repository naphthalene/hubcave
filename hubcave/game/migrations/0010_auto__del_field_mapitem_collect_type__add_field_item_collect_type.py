...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MapItem.collect_type'
        db.delete_column(u'game_mapitem', 'collect_type')

        # Adding field 'Item.collect_type'
        db.add_column(u'game_item', 'collect_type',
                      self.gf('django.db.models.fields.CharField')(default='IV', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MapItem.collect_type'
        db.add_column(u'game_mapitem', 'collect_type',
                      self.gf('django.db.models.fields.CharField')(default='IV', max_length=2),
                      keep_default=False)

        # Deleting field 'Item.collect_type'
        db.delete_column(u'game_item', 'collect_type')
    ...
    models = {
        ...
        u'game.item': {
            ...
            'collect_type': ('django.db.models.fields.CharField', [], {'default': "'IV'", 'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
